...
use App\Core\Modules\Dictionary\Dto\WordTranslationDto;
...
final class WordMapper
{
    ...
    public function mapWordProgressModelToDto(UserWordProgress $progress, ?UtcOffset $utcOffset = null): WordProgressDto
    {
