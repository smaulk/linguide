...
{
    public function run(UserWordProgress $progress, WordReviewAnswerResult $result): UserWordProgress
    {
        match ($result) {
            WordReviewAnswerResult::CORRECT => $this->processCorrect($progress),
            WordReviewAnswerResult::WRONG   => $this->processWrong($progress),
        };
